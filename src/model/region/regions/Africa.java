...
public class Africa
    ...
    public Africa(String name, Color color, int population, RegionPoint regionPoint, Consumer<Region> callback, Difficulty difficulty) {
        super(name, color, population, regionPoint, callback, difficulty);
    }

    public Africa(String name, Color color, int population, RegionPoint regionPoint, Consumer<Region> callback, Difficulty difficulty, Set<TransportType> supportedTransportTypes) {
