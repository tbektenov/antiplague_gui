...
public class SouthAsia
    ...
    public SouthAsia(String name, Color color, int population, RegionPoint regionPoint, Consumer<Region> callback, Difficulty difficulty) {
        super(name, color, population, regionPoint, callback, difficulty);
    }

    public SouthAsia(String name, Color color, int population, RegionPoint regionPoint, Consumer<Region> callback, Difficulty difficulty, Set<TransportType> supportedTransportTypes) {
